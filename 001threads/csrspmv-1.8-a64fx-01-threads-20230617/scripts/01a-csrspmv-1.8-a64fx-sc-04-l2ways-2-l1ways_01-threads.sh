...
# Example usage:
#
#  $ pjsub scripts/01a-csrspmv-1.8-a64fx-sc-04-l2ways-2-l1ways_01-threads.sh --verbose
#
# ChangeLog:
#
...
#PJM -N csrspmv-1.8-a64fx-sc-04-l2ways-2-l1ways_01-threads
#PJM -g jh180024o
...
#PJM -o logs/01a-csrspmv-1.8-a64fx-sc-04-l2ways-2-l1ways_01-threads-stdout.txt
#PJM -e logs/01a-csrspmv-1.8-a64fx-sc-04-l2ways-2-l1ways_01-threads-stderr.txt
...
export CSRSPMV=bin/csrspmv-1.8-a64fx-sc-04-l2ways-2-l1ways
./scripts/01a-csrspmv.sh \
    ...
    --repeat=100 \
    --warmup=3 \
    --outdir=results/01a-csrspmv-1.8-a64fx-sc-04-l2ways-2-l1ways-$(date +%Y%m%d)
