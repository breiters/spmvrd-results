...
# Example usage:
#
#  $ pjsub scripts/01a-csrspmv-1.6-a64fx-sc-08-l2ways_48-threads.sh --verbose
#
# ChangeLog:
#
...
#PJM -N csrspmv-1.6-a64fx-sc-08-l2ways_48-threads
#PJM -g jh180024o
...
#PJM -o logs/01a-csrspmv-1.6-a64fx-sc-08-l2ways_48-threads-stdout.txt
#PJM -e logs/01a-csrspmv-1.6-a64fx-sc-08-l2ways_48-threads-stderr.txt
...
export CSRSPMV=bin/csrspmv-1.6-a64fx-sc-08-l2ways
./scripts/01a-csrspmv.sh \
    ...
    --papi-event-summary \
    --repeat=100 \
    --outdir=results/01a-csrspmv-1.6-a64fx-sc-08-l2ways-$(date +%Y%m%d)
