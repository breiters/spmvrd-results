...
if __name__ == '__main__':
    df_scaled = pd.read_csv('scaled/overhead048t.csv')
    df_calc_sc = pd.read_csv('calc/sc/overhead048t.csv')
    df_calc_nosc = pd.read_csv('calc/nosc/overhead048t.csv')
    ...
    print('max: ', df_calc['time'].max())
    print('max: ', df_scaled['time'].max())
